...
<html lang="en">
	...
	?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>SV AgroCulture</h2>
						<p>Explore afresh way of trading...</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">SV AgroCulture &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">SV Agro Culture Farm<span>Karnataka</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">7868905431</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:srivaragroculture@gmail.com" style="color:white">sv@agroculture.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About SV AgroCulture</b></span>
				SV AgroCulture is e-commerce trading platform for grains & groceries...
			</p>
